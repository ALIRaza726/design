...
import 'package:meditate/screen/cartScreen.dart';
import 'package:provider/provider.dart';

class ScrolLinked extends StatefulWidget {
  static const routeName = '/ScrolLinked';
  const ScrolLinked({super.key});

  @override
  State<ScrolLinked> createState() => _MenuScreenState();
}

class _MenuScreenState extends State<ScrolLinked> {
